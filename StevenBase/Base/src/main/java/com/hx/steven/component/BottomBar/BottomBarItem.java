...
public class BottomBarItem extends LinearLayout {
    ...
    public BottomBarItem(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, AppUtils.sp2px(mContext, mTextSize));
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, AppUtils.dip2px(mContext, mMarginTop));
        ...
        mUnreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, AppUtils.sp2px(mContext, mUnreadTextSize));
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, AppUtils.sp2px(mContext, mMsgTextSize));
